...
class OJDEvictions(scrapy.Spider):
	...
	case_search_form = {
		...
		'CaseSearchValue': '20LT*', # change this for a different case search
		'CitationSearchValue': '',
	...
	def parse_select_place(self, resp, node_id, location):
		...
		for month in self.month_list:
			...
			starting_date = "{month}/{day}/2020".format(month = str(month).zfill(2), day = '01')
			ending_date = "{month}/{day}/2020".format(month = str(month).zfill(2), day = str(calendar.monthrange(2020,month)[1]).zfill(2))
