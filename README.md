...
11. Note that if you do not want to download court documents from the scrape, turn of the FilesPipeline on line 84 of the settings.py file by preceding it with a #. 
